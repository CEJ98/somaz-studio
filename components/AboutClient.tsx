...
export default function AboutClient() {
  ...
  const values = [
    {
      number: '01',
      title: locale === 'es' ? 'Precisión' : 'Precision',
      desc: locale === 'es'
    ...
    {
      number: '02',
      title: locale === 'es' ? 'Claridad' : 'Clarity',
      desc: locale === 'es'
        ...
        <div className="absolute inset-0">
          ...
          {videoReady && (
            <video
              ...
              aria-hidden="true"
              poster="/library/video/about-loop-poster.jpg"
            >
              <source src="/library/video/about-loop-720.webm" type="video/webm" />
              <source src="/library/video/about-loop-1080.mp4" type="video/mp4" />
            </video>
          )}
        ...
        <div className="max-w-7xl mx-auto">
          <FadeUp className="mb-16">
            ...
            <h2 className="font-serif font-light italic text-foreground/80" style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)' }}>
              {locale === 'es' ? 'Lo que guía cada decisión.' : 'What guides every decision.'}
            </h2>
          </FadeUp>
