...
export const seoLandings: SeoLanding[] = [
  {
    ...
    proofPoints: [
      { en: 'Architectural direction without local-office overhead.', es: 'Dirección arquitectónica sin la estructura pesada de una oficina local grande.' },
      { en: 'Clear packages for clients, builders, and consultants.', es: 'Paquetes claros para clientes, constructores y consultores.' },
      { en: 'A clear handoff when another local technical team needs to step in.', es: 'Una transición clara cuando después debe entrar otro equipo técnico local.' },
    ],
    ...
    audienceBody: {
      ...
      es: 'Desarrolladores, operadores de hospitality, propietarios y estudios de arquitectura que necesitan un proceso de diseño sólido y entregables claros.',
    },
    scopeTitle: { en: 'Typical scope', es: 'Alcance típico' },
    scopeItems: [
      { en: 'Concept and schematic design', es: 'Concepto y diseño esquemático' },
      { en: 'Interior architecture and material direction', es: 'Arquitectura interior y dirección material' },
  ...
  },
  {
    ...
    proofPoints: [
      { en: 'Spatial decisions come before image-making.', es: 'Las decisiones de proyecto vienen antes que la producción de imágenes.' },
      ...
      { en: 'Every deliverable is built to align stakeholders.', es: 'Cada entregable está armado para alinear decisiones entre las partes involucradas.' },
    ],
    ...
    scopeItems: [
      { en: 'Spatial concept and decision logic', es: 'Idea principal y lógica de decisión' },
    ...
    ctaBody: { en: 'We will tell you whether the right next step is discovery, strategy consult, or phased proposal.', es: 'Te diremos si el siguiente paso correcto es una llamada inicial, una consulta estratégica o una propuesta por fases.' },
    primaryService: 'Architecture',
    primaryAudience: 'Developer',
    primaryMarket: 'Global',
    ...
    faq: [
      {
        ...
        answer: { en: 'The work starts from scope, spatial decisions, and project readiness. Visualization is one tool inside the process, not the whole service.', es: 'El trabajo arranca desde el alcance, las decisiones de diseño y la preparación del proyecto. La visualización es una herramienta dentro del proceso, no todo el servicio.' },
      },
      {
        question: { en: 'Do you also handle interiors?', es: '¿También manejan interiores?' },
        answer: { en: 'Yes. Interiors are part of the process whenever the project needs material, furnishing, and spatial clarity.', es: 'Sí. Los interiores forman parte del proceso cuando el proyecto necesita claridad en materiales, equipamiento y uso del espacio.' },
      },
    ],
  },
  {
    ...
    metaTitle: { en: 'Architectural Visualization for Developers, Permits, and Investor Presentations', es: 'Visualización Arquitectónica para Desarrolladores, Permisos y Presentaciones a Inversores' },
    metaDescription: {
      ...
      es: 'Visualización arquitectónica que ayuda a desarrolladores, arquitectos y propietarios a presentar proyectos con claridad para permisos, inversores y marketing previo a obra.',
    },
    ...
    proofPoints: [
      ...
      { en: 'Pre-construction sales and stakeholder alignment', es: 'Venta previa a obra y alineación entre equipos' },
    ],
    audienceTitle: { en: 'Typical clients', es: 'Clientes típicos' },
    audienceBody: { en: 'Developers, architects, and sales teams that need imagery grounded in real spatial, regulatory, and commercial logic.', es: 'Desarrolladores, arquitectos y equipos comerciales que necesitan imágenes apoyadas en criterios reales de diseño, revisión y venta.' },
    ...
    scopeItems: [
      ...
      { en: 'Images designed for boards, clients, and stakeholders', es: 'Imágenes pensadas para juntas, clientes y equipos de decisión' },
    ],
    ...
    ctaBody: { en: 'Send the project and we will define the right package based on approvals, sales, or investor use.', es: 'Envía el proyecto y definiremos el paquete correcto según aprobación, ventas o presentación a inversores.' },
  ...
  },
  {
    ...
    title: { en: 'Interior Architecture', es: 'Arquitectura Interior' },
    metaTitle: { en: 'Interior Architecture for Hospitality and Premium Residential Projects', es: 'Arquitectura Interior para Hospitality y Residencial Premium' },
    metaDescription: {
      ...
      es: 'Arquitectura interior para proyectos de hospitality y residencial premium. Materiales, distribución, equipamiento e imágenes para apoyar la ejecución.',
    },
    heroEyebrow: { en: 'Interior Architecture', es: 'Arquitectura Interior' },
    ...
    audienceBody: { en: 'Boutique hospitality operators, developers, and residential clients who want more than decoration and need interiors with architectural discipline.', es: 'Operadores boutique de hospitality, desarrolladores y clientes residenciales que quieren algo más que decoración y necesitan interiores con criterio arquitectónico.' },
    ...
    ctaBody: { en: 'Start the intake and we will tell you whether the right path is interior architecture, concept, or a strategy consult.', es: 'Empieza con una consulta y te diremos si la ruta correcta es arquitectura interior, concepto o una asesoría estratégica.' },
    ...
    faq: [
      {
        ...
        answer: { en: 'No. Interior architecture is often most valuable before documentation or contractor coordination, when layout, material, and furniture decisions are still open.', es: 'No. La arquitectura interior suele ser más valiosa antes de la documentación o la coordinación con contratistas, cuando las decisiones de distribución, materiales y equipamiento todavía están abiertas.' },
      },
      {
        question: { en: 'Can this be delivered remotely?', es: '¿Esto se puede entregar en remoto?' },
        answer: { en: 'Yes. The process is built for remote collaboration and can later integrate with local contractors, builders, or licensed partners.', es: 'Sí. El proceso está pensado para colaboración remota y luego puede integrarse con contratistas, constructores o profesionales locales.' },
      },
    ],
  },
  {
    ...
    heroTitle: { en: 'Clarity reduces friction in approvals.', es: 'La claridad reduce fricción en las aprobaciones.' },
    heroBody: { en: 'Somaz prepares presentation packages that make a project easier to read for boards, HOAs, clients, and review teams. The goal is simple: reduce ambiguity before the next decision point.', es: 'Somaz prepara paquetes de presentación que vuelven el proyecto más legible para juntas, HOAs, clientes y equipos de revisión. El objetivo es simple: reducir ambigüedad antes del siguiente punto de decisión.' },
    proofTitle: { en: 'Typical outcomes', es: 'Resultados típicos' },
    proofPoints: [
      { en: 'Fewer follow-up questions', es: 'Menos preguntas de seguimiento' },
      { en: 'Clearer alignment between owner, partner, and board', es: 'Alineación más clara entre propietario, equipo técnico y junta de revisión' },
    ...
    audienceBody: { en: 'Developers, homeowners, architect partners, and teams preparing projects for review, permit, or stakeholder approval.', es: 'Desarrolladores, propietarios, estudios de arquitectura y equipos que preparan proyectos para revisión, permiso o aprobación.' },
    ...
    scopeItems: [
      ...
      { en: 'Presentation-ready material for boards and clients', es: 'Material listo para presentar a juntas y clientes' },
    ],
    ...
    faq: [
      {
        ...
        answer: { en: 'No. It supports the permit or review process by making the proposal easier to understand. The local permit set and sign-off remain with the properly licensed professional where required.', es: 'No. Apoya el proceso de permiso o revisión haciendo la propuesta más fácil de entender. La documentación local y la firma siguen a cargo del profesional habilitado cuando corresponde.' },
      },
      {
        question: { en: 'Does this help with HOA review?', es: '¿Esto ayuda con revisiones de HOA?' },
        answer: { en: 'Yes. HOA and neighborhood reviews often respond better to clear exterior and context visuals than to technical drawings alone.', es: 'Sí. Las revisiones de HOA y vecinales suelen responder mejor a visuales claros de exterior y contexto que a dibujos técnicos solos.' },
      },
    ],
  },
  {
    ...
    metaDescription: {
      ...
      es: 'Estudio de arquitectura remoto para proyectos que necesitan dirección de diseño sólida, entregables claros y colaboración eficiente entre mercados.',
    },
    heroEyebrow: { en: 'Remote-First Delivery', es: 'Trabajo Remoto' },
    ...
    heroBody: { en: 'Somaz is built for remote work: intake, design, interiors, visualization, and coordination. The process stays simple, documented, and easy to share with clients and collaborators.', es: 'Somaz está preparado para trabajo remoto: briefing, diseño, interiores, visualización y coordinación. El proceso se mantiene simple, documentado y fácil de compartir con clientes y colaboradores.' },
    proofTitle: { en: 'Why clients choose remote-first', es: 'Por qué algunos clientes eligen trabajar en remoto' },
    proofPoints: [
      ...
      { en: 'Packages built for cloud collaboration and local execution', es: 'Paquetes armados para colaboración digital y ejecución local' },
    ],
    audienceTitle: { en: 'Best fit', es: 'Mejor fit' },
    ...
    scopeItems: [
      { en: 'Digital intake and briefing', es: 'Briefing digital' },
      { en: 'Phased design and presentation packages', es: 'Diseño por fases y paquetes de presentación' },
      { en: 'Coordination with builders, consultants, and external teams', es: 'Coordinación con constructores, consultores y equipos externos' },
    ],
    ctaTitle: { en: 'If the project can move remotely, the process should be built for that.', es: 'Si el proyecto puede avanzar en remoto, el proceso debe ser claro desde el inicio.' },
    ctaBody: { en: 'We will scope the right remote-first path based on the project, team, and next decision.', es: 'Vamos a definir la ruta correcta según el proyecto, el equipo y la próxima decisión.' },
    primaryService: 'Architecture',
    primaryAudience: 'Developer',
    primaryMarket: 'Global',
    ...
    faq: [
      ...
      },
      {
        ...
        answer: { en: 'No. Remote delivery works for architecture, interiors, concept, and technical preparation when the process is scoped correctly.', es: 'No. El trabajo remoto funciona para arquitectura, interiores, concepto y preparación técnica cuando el proceso está bien definido.' },
      },
    ],
  },
  {
    ...
    scopeItems: [
      ...
      { en: 'Interior architecture and material systems', es: 'Arquitectura interior y sistemas materiales' },
  ...
  },
  {
    ...
    audienceBody: { en: 'Developers, premium homeowners, and hospitality operators who need a clear architectural direction and a polished package for Miami.', es: 'Desarrolladores, propietarios premium y operadores de hospitality que necesitan una dirección arquitectónica clara y un paquete bien resuelto para Miami.' },
    ...
    faq: [
      {
        ...
        answer: { en: 'Some Miami projects need a separate local technical team for later stages. Somaz can coordinate that handoff when needed.', es: 'Algunos proyectos en Miami necesitan un equipo técnico local separado para etapas posteriores. Somaz puede coordinar esa transición cuando hace falta.' },
      },
      {
  ...
  },
  {
    ...
    heroEyebrow: { en: 'Partner Model', es: 'Modelo con Equipos Externos' },
    ...
    proofPoints: [
      ...
      { en: 'Creates a cleaner handoff between concept and technical development', es: 'Crea una transición más limpia entre concepto y desarrollo técnico' },
    ],
    audienceTitle: { en: 'Best fit', es: 'Mejor fit' },
    audienceBody: { en: 'Clients and architect partners who need a project to move across markets without losing design clarity.', es: 'Clientes y estudios de arquitectura que necesitan que un proyecto avance entre mercados sin perder claridad de diseño.' },
    ...
    scopeItems: [
      ...
      { en: 'The handoff stays clear from the beginning', es: 'La transición queda clara desde el principio' },
    ],
