  ...
  const jsonLd = JSON.stringify([
    {
      ...
      creator: { '@type': 'Organization', name: 'Somaz Studio', '@id': 'https://somazstudio.com/#business' },
      locationCreated: {
        '@type': 'Place',
        name: project.location,
        ...(project.location.includes('Miami') ? { address: { '@type': 'PostalAddress', addressLocality: 'Miami', addressRegion: 'FL', addressCountry: 'US' } } : {}),
      },
